...
echo "• Place scheduler_analysis_*.json files in your project root for enhanced analysis"
echo "• The plugin automatically detects and uses JSON files when available"
echo "• Falls back to live log analysis if no JSON files are found"
echo ""

echo -e "${YELLOW}🔄 Next Steps:${NC}"
echo "1. Place your JSON analysis file in the project root:"
echo "   cp scheduler_analysis_*.json ."
echo "2. Restart k9s"
echo "3. Test the plugin: k9s → select pod → Ctrl-D"
